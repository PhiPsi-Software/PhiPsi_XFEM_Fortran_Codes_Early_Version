...
C                         c_PERROR, PERVEC, PJAC, PMULT, PRBNDX,      
...
C                        PERMAT, c_PERROR, PERVEC, PJAC, PMULT, PRBNDX, 
...
C       
C     c_PERROR COMPUTES THE RESIDUAL, R = RHS - A*U.  THE USER
...
C     VECTORS - CALLED FROM c_PERROR    
C       
C ... PARAMETER LIST:       
C       
